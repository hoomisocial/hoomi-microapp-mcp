...
- Create/update micro-app tools: the API requires multipart uploads and returns `app_secret`; the create operation is being implemented with one-time UI handoff.
